			...
			if(Objects.nonNull(jwtUser))
			 {
				...
				UserRole userRoleToken=userRoleRepository.findByRoleName(user.getUserRole().getRoleName());
				
				if(StringUtils.equals("Admin", userRoleToken.getRoleName()) || StringUtils.equals("sales manager", userRoleToken.getRoleName()))
				{
